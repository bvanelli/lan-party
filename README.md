...
This repo is dedicated to how to run a LAN Party within your organization with minimal setup. I have included
docker-compose scripts and minimal documentation on how to run each one of them, including mod installs.
...
include both CS 1.6 and CS:Source. 
...
so [make sure to install it](https://jdk.java.net/23/).**
